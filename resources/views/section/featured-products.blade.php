<x-app-layout>
    ...
    <div class="main main-app p-3 p-lg-4">
        <div class="container mt-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h4 class="main-title mb-0">Featured Products Section</h4>
            </div>
            ...
            <div class="card p-4">
                <h5 class="card-title mb-4">Select Products for Featured Products Section</h5>
                
                <form id="featuredProductsForm" action="{{ route('featured-products.store.products') }}" method="POST">
                    @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('featuredProductsForm');
