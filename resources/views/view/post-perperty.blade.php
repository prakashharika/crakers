...
<div class="main-sell">
    <div class="contact-page-container">
        <div class="property-page-form">
            <div class="container property-form">
                 <div class="row property-form-row align-items-center">
                <!-- Heading and Redirect Section -->
                <div class="row sell-property-action-container">
                    <!-- Left Column: Heading -->
                    <div class="col-md-6 mb-3 mb-md-0">
                        <h1 class="sell-property-heading">Post your Property with Us</h1>
                    </div>

                    <!-- Right Column: Heading and Link -->
                ...
                <!-- Image and Form Section -->
                    ...
                    <div class="col-md-6 contact-page-image">
                        <img src="{{ asset('assets/images/propertyimage.avif') }}" alt="Description of the image" class="img-fluid" style="border-radius: 10px;">
                    </div>

                    <!-- Right Column: Form -->
                    <div class="col-md-6">
                        <form class="" action="{{ route('landowner.entery') }}" method="post" novalidate>
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control w-100" placeholder="Enter your phone number" required>
                                    <div class="error-message text-danger small"></div>
                                </div>
                                
                                  <!-- WhatsApp Updates Toggle -->
                            <div class="updates-container mb-3 mt-4">
                                ...
                                <div class="updates-toggle">
                                    <label class="switch">
                                        <input type="checkbox" name="isthiswhatsapp" id="toggle-switch" checked>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="city" name="city" class="form-control w-100" placeholder="Enter your city" required>
                                    <div class="error-message text-danger small"></div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn submit-button mb-4">Post Your Property</button>
                            </div>
                        </form>
                    </div>
                </div>
