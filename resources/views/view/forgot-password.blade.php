    ...
    <div class="card shadow-lg p-4 p-md-5 border-0 rounded-4 animate__animated animate__fadeInDown login-card">
        <div class="text-center mb-4">
            <div class="logo-container mb-3 animate__animated animate__bounceIn">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-key text-white" viewBox="0 0 16 16">
            ...
            <p class="text-light mb-0 opacity-75">Enter your email to receive a reset link</p>
        </div>
        ...
        <form method="POST" action="{{ route('user.password.email') }}" class="needs-validation" novalidate>
            @csrf
